...
export default function BasicAccordion({title, summary,logoTitle}:AccordionProps) {
  return (
    <div className='flex gap-10 items-start flex-col h-[82]'>
      <Accordion  className={`${satoshi.className} bg-black text-white font-light border-x-0 border-b-2 border-[#13171d]`}>
        <AccordionSummary
        ...
        >
          ...
          <Typography className={`${satoshi.className} accordionHeading `}>{title}</Typography>
        </AccordionSummary>
        <AccordionDetails >
